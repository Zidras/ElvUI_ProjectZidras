	...
	if element then
		...
		if element.overAbsorb then
			if element.overAbsorb:IsObjectType("Texture") and not element.overAbsorb:GetTexture() then
				element.overAbsorb:SetTexture([[Interface\AddOns\ElvUI_ProjectZidras\Media\Textures\RaidFrame\Shield-Overshield]])
		...
		if element.overHealAbsorb then
			if element.overHealAbsorb:IsObjectType("Texture") and not element.overHealAbsorb:GetTexture() then
				element.overHealAbsorb:SetTexture([[Interface\AddOns\ElvUI_ProjectZidras\Media\Textures\RaidFrame\Absorb-Overabsorb]])
