...
local function NamePlatesOptions()
	...
	tags.titleGroup = ACH:Group(L["Title"], nil, 2, nil, function(info) return E.db.pz.nameplates.tags.title[info[#info]] end, function(info, value) E.db.pz.nameplates.tags.title[info[#info]] = value NP:ConfigureAll() end)
	tags.titleGroup.args.enable = ACH:Toggle(L["Title/Rank in target nameplate"], L["Show title or PvP rank in target nameplate"], 1)
