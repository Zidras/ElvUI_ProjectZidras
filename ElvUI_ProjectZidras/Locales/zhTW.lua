...
L["Armory module that displays gems and enchants to the character and inspect frames.\nBest paired with Enhanced Character Frame from |cff1784d1E|r|cffe5e3e3lvUI|r |cff1784d1E|r|cffe5e3e3nhanced|r."] = "軍械庫模塊，用於顯示角色的寶石和附魔並檢查框架。\n最好與來自 |cff1784d1E|r|cffe5e3e3lvUI|r |cff1784d1E|r|cffe5e3e3nhanced|r 的增強角色框架配對。"
L["Based on the unit's target, which isn't always an indicator of the cast target. Will be inaccurate for self/mouseover/macro casts if unit is targeting elsewhere."] = "基於單位的目標，這並不總是表明施法目標。如果單位瞄准其他地方，自我/鼠標懸停/宏施法將不准確。"
...
L["Display the target of the current cast in the castbar"] = "在施法欄中顯示當前施法的目標"
L["Donators"] = "捐贈者"
L["Duration in seconds into the future to look for incoming healing."] = "未來幾秒內尋找即將到來的治療的持續時間。"
...
L["Group Units"] = "隊伍單位"
L["GUID"] = true
L["GUID_DESC"] = "如果緩存，則在銘牌上顯示 UnitGUID。"
