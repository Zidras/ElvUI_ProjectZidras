...
L["Armory module that displays gems and enchants to the character and inspect frames.\nBest paired with Enhanced Character Frame from |cff1784d1E|r|cffe5e3e3lvUI|r |cff1784d1E|r|cffe5e3e3nhanced|r."] = "军械库模块，在角色和检查框架上显示宝石和附魔。\n最好与来自|cff1784d1E|r|cffe5e3e3lvUI|r|cff1784d1E|r|cffe5e3e3nhanced|r的强化角色框架配对。"
L["Based on the unit's target, which isn't always an indicator of the cast target. Will be inaccurate for self/mouseover/macro casts if unit is targeting elsewhere."] = "基于单位的目标，这并不总是表明施法目标。如果单位瞄准其他地方，自我/鼠标悬停/宏施法将不准确。"
...
L["Display the target of the current cast in the castbar"] = "在施法栏中显示当前施法的目标"
L["Donators"] = "捐赠者"
L["Duration in seconds into the future to look for incoming healing."] = "未来几秒内寻找即将到来的治疗的持续时间。"
...
L["Group Units"] = "群体单位"
L["GUID"] = true
L["GUID_DESC"] = "如果缓存，则在铭牌上显示 UnitGUID。"
