...
L["Armory module that displays gems and enchants to the character and inspect frames.\nBest paired with Enhanced Character Frame from |cff1784d1E|r|cffe5e3e3lvUI|r |cff1784d1E|r|cffe5e3e3nhanced|r."] = "Модуль Armory, который отображает драгоценные камни и зачарования для персонажа и рамки осмотра.\nЛучше всего работает в паре с Enhanced Character Frame из |cff1784d1E|r|cffe5e3e3lvUI|r |cff1784d1E|r|cffe5e3e3nhanced|r."
...
L["Quality Color"] = "Цвет изделия качественный"
L["Raid"] = "Рейд"
L["Ranged Slot"] = "Оружие дальнего боя"
L["Reversed"] = "Перевернутый"
L["Secondary Hand Slot"] = "Левая рука"
