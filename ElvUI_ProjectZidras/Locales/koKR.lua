...
L["Armory module that displays gems and enchants to the character and inspect frames.\nBest paired with Enhanced Character Frame from |cff1784d1E|r|cffe5e3e3lvUI|r |cff1784d1E|r|cffe5e3e3nhanced|r."] = "캐릭터에 보석과 마법 부여를 표시하고 프레임을 검사하는 무기고 모듈입니다.\n|cff1784d1E|r|cffe5e3e3lvUI|r |cff1784d1E|r|cffe5e3e3nhanced|r의 향상된 캐릭터 프레임과 가장 잘 짝을 이룹니다."
L["Based on the unit's target, which isn't always an indicator of the cast target. Will be inaccurate for self/mouseover/macro casts if unit is targeting elsewhere."] = "시전 대상을 항상 나타내는 것은 아닌 유닛의 대상을 기준으로 합니다. 유닛이 다른 곳을 대상으로 하는 경우 자체/마우스오버/매크로 시전에는 정확하지 않습니다."
...
L["Display the target of the current cast in the castbar"] = "캐스트바에 현재 캐스트의 대상 표시"
L["Donators"] = "기부자"
L["Duration in seconds into the future to look for incoming healing."] = "수신되는 치유를 찾는 미래의 지속 시간(초)입니다."
...
L["Group Units"] = "그룹 단위"
L["GUID"] = true
L["GUID_DESC"] = "캐시된 경우 명판에 UnitGUID를 표시합니다."
...
L["Quality Color"] = "아이템 퀄리티 컬러"
L["Raid"] = "공격대"
L["Ranged Slot"] = "원거리 장비"
L["Reversed"] = "반전"
L["Secondary Hand Slot"] = "보조장비"
L["Separator"] = "분리 기호"
L["Stacked"] = "쌓인"
...
L["Target"] = "대상"
L["Unit_DESC"] = "캐시된 경우 명판에 단위를 표시합니다."
